...
# Reducir mensajes verbosos de TensorFlow y desactivar oneDNN para salida estable
...
history = model.fit(
    X, y,
    epochs=200,        # reducido para ejecutar rápido y mostrar progreso
    verbose=1          # 1 = barra de progreso por época
)
